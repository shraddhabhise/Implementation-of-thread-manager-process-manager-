...
_StringConst_13:
	.word	79			! length
	.ascii	"\n====================  INITIAL STATE FOR PROCESS MANAGER ====================\n\n"
	.align
_StringConst_12:
	.word	60			! length
	.ascii	"\n=========================================================\n\n"
...
_StringConst_1:
	.word	77			! length
	.ascii	"\n====================  INITIAL STATE OF THREAD MANAGER ====================\n\n"
	.align
	.text
! 
! =====  MAIN ENTRY POINT  =====
...
! Make sure _P_List_ has hash value 0xafebcabb (decimal -1343501637)
	...
	cmp	r1,0
	bne	_Label_63
! Make sure _P_Kernel_ has hash value 0xddb77879 (decimal -575178631)
	set	_packageName,r2
	set	0xddb77879,r3
